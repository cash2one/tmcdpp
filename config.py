...
define("mysql_user", default="root", help="blog database user")#temp
...
define('act_agree_per_page',default="8")
define('act_attend_per_page',default="8")
define('apply_per_page',default="8")
define('dy_per_page',default="5")
